                ...
                <div class="container p-4 bg-white text-center" id="getPrint">
                    <div class="bg-white m-auto">
                        <div class="row">
                            ...
                            <h2 class="mb-4">Turn Around Time Summary</h2>
                                <p style="font-size: 1.2rem">
                                    <span class="bg-dark text-white">TAT FIlter Summary</span>
                                </p>
                                <p>
                            ...
                            <div class="table mt-4">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th><b>Complaints Resulotion Detail</b></th>
                                            <th><b>Total Complaints</b></th>
                                            <th><b>Percentage</b></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse($tat_complete_filter as $record)
                                            <tr>
                                                <td>{{ $record->ResolutionDetails }}</td>
                                                <td>{{ $record->TotalComplaints }}</td>
