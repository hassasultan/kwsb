        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 pb-2">
                    ...
                    <form role="form" method="POST" action="{{ route('user-management.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 p-3">
                                ...
                                <input type="password" class="form-control border-bottom border-1 border-dark"
                                placeholder="Enter Password Confirmation..." name="password_confirmation" required autocomplete="new-password" value="{{ old('password_confirmation') }}"/>
                            </div>
